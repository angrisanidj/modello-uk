...
- Risultato 2019 della componente geografica: 609/632 vincitori corretti, errore assoluto complessivo sui seggi 14. È un risultato usato nella calibrazione interna (in-sample/tuning), non una validazione indipendente: il 2019 è stato usato per selezionare la forza geografica 0,875.
- Confronto 2024 sulla geografia YouGov: 578/632, errore seggi 56.
- Validazione incrociata geografica 2024, con esclusione a turno di una regione, della combinazione delle fonti esterne: 584/632, errore seggi 44. Questa misura non usa un’elezione completamente separata dalla calibrazione: serve a validare la ponderazione geografica delle fonti esterne.
...
- Restore Britain è incluso nel polling nazionale ma non nella conversione collegio per collegio, in attesa di una base geografica e di candidature sufficientemente solida.
- L'incertezza nazionale Monte Carlo usa un moltiplicatore ×1,75 e shock normali Box–Muller a sei estrazioni fisse dal generatore casuale. Nell'A/B di promozione sulle stesse 50.000 simulazioni, le σ effettive post-rinormalizzazione sono 2,1205 p.p. per Labour, 2,1111 per Conservative e 2,0970 per Reform UK (≈2,11 p.p.), al limite inferiore del intervallo esterno BPC 2,07–2,43. Il primo esperimento resta registrato come FAIL perché il gate a >4 p.p. era mal specificato (~1,9σ); il secondo esperimento preregistrato passa i gate a >6 p.p., scala e stabilità parlamentare. Sui 450.000 shock grezzi Box–Muller produce 10 draw oltre il supporto finito dell'Irwin–Hall, contro 9,94 attesi da una normale. La modifica corregge la forma dell'incertezza, non il centro del modello, e non introduce effetti sistematici degli istituti (house effects) o nuove correlazioni strutturali. Il 1992 resta un precedente utile: nel confronto storico della House of Commons Library, l'ultimo sondaggio Ipsos MORI mancò il divario Conservative–Labour del risultato di circa 8,6 p.p., quindi errori molto grandi non devono essere impossibili per costruzione.
