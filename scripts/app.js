...
const CONFIG = {
  ...
  gbSeats: 632,
  niSeats: 18,
  cacheVersion: 'uk-v098-20260826-party-calibration',
  swingLambda: 0.82,
...
function mrpLiteActive(){
  ...
  return m?.version==='uk-v098-party-calibration-live'
    && m?.model_type==='constituency-residual-party-calibration-v3'
    && m?.status==='ok'
    && m?.approved===true
